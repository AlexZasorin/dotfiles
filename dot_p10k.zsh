# Generated by Powerlevel10k configuration wizard on 2025-12-08 at 11:32 PST.
...
() {
  ...
  #   typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_VISUAL_IDENTIFIER_EXPANSION='⭐'
    typeset -g POWERLEVEL9K_KUBECONTEXT_TEST_CONTENT_EXPANSION='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      '*staging*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
